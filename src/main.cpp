...
#define TEMPERATURE_OVERREAD_C 0
...
void publish()
{
  ...
  {
    float temperature = bmp388.temperature - TEMPERATURE_OVERREAD_C;
...
void setup()
{
  ...
  {
    hasVEML7700 = true;
    veml7700.setGain( VEML7700_GAIN_1_4 );
  ...
  timer.setInterval( SAMPLE_DURATIONS_SECS * 1000L, publish );
}
